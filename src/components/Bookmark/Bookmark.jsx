...
const Bookmark = ({ bookmark, handleRemoveFromBookmark }) => {
    return (
        <div className="p-5 bg-white rounded-xl relative">
            <button className="absolute top-3 right-1 -translate-y-2 opacity-20 hover:opacity-100 cursor-pointer" onClick={() => handleRemoveFromBookmark(bookmark)}><RxCross2 /></button>
